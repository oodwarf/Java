...
public class AddShouCangJiaServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AddShouCangJiaServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Message message : list) {
			...
			if (id == message.getId()) {
				...
				if (isNew) {
					Smessage n = new Smessage(id, message.getName(),
							message.getPosition(), 1);
		...
		response.sendRedirect(request.getContextPath() + "/servlet/HallServlet");
